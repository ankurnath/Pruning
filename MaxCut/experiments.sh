...
# python knapsack_gnn_pruning.py --dataset Wiki  --cost_model degree  
# python knapsack_gnn_pruning.py --dataset Deezer  --cost_model degree 
# python knapsack_gnn_pruning.py --dataset Slashdot  --cost_model degree 
# python knapsack_gnn_pruning.py --dataset Twitter  --cost_model degree  
# python knapsack_gnn_pruning.py --dataset DBLP  --cost_model degree  
# python knapsack_gnn_pruning.py --dataset YouTube  --cost_model degree  
# python knapsack_gnn_pruning.py --dataset Skitter  --cost_model degree
...
# python quickfilter.py --dataset DBLP  --budget 100 --delta 0.1 
# python quickfilter.py --dataset Facebook  --budget 100 --delta 0.1
# python quickfilter.py --dataset Skitter  --budget 100 --delta 0.1
# python quickfilter.py --dataset Slashdot  --budget 100 --delta 0.1
# python quickfilter.py --dataset Twitter  --budget 100 --delta 0.1
# python quickfilter.py --dataset web-Google  --budget 100 --delta 0.1
# python quickfilter.py --dataset Wiki  --budget 100 --delta 0.1
# python quickfilter.py --dataset YouTube  --budget 100 --delta 0.1
...
# python Bilmes.py --dataset Deezer --budget 100
# python Bilmes.py --dataset Slashdot --budget 100
# python Bilmes.py --dataset Twitter --budget 100
# python Bilmes.py --dataset DBLP --budget 100
# python Bilmes.py --dataset YouTube --budget 100
# python Bilmes.py --dataset Skitter --budget 100

# python Bilmes.py --dataset Facebook  --budget 100 
# python Bilmes.py --dataset Skitter  --budget 100 
# python Bilmes.py --dataset Slashdot  --budget 100 
# python Bilmes.py --dataset Twitter  --budget 100 
# # python Bilmes.py --dataset web-Google  --budget 100 
# python Bilmes.py --dataset Wiki  --budget 100 
# python Bilmes.py --dataset YouTube  --budget 100 
...
# python GNN_pruning.py --dataset Skitter  --budget 100 
# python GNN_pruning.py --dataset Slashdot  --budget 100 
# python GNN_pruning.py --dataset Twitter  --budget 100 
# python GNN_pruning.py --dataset web-Google  --budget 100 
# python GNN_pruning.py --dataset Wiki  --budget 100 
# python GNN_pruning.py --dataset YouTube  --budget 100


# python gcomb_train.py --dataset DBLP  --budget 10 20 50 100 200 
# python gcomb_train.py --dataset Facebook  --budget 10 20 50 100 200
# python gcomb_train.py --dataset Skitter  --budget 10 20 50 100 200
# python gcomb_train.py --dataset Slashdot  --budget 10 20 50 100 200
# python gcomb_train.py --dataset Twitter  --budget 10 20 50 100 200
# python gcomb_train.py --dataset web-Google  --budget 10 20 50 100 200
# python gcomb_train.py --dataset Wiki  --budget 10 20 50 100 200
# python gcomb_train.py --dataset YouTube  --budget 10 20 50 100 200


# python gcomb_test.py --dataset DBLP  --budget 100 
# python gcomb_test.py --dataset Facebook  --budget 100 
# python gcomb_test.py --dataset Skitter  --budget 100 
# python gcomb_test.py --dataset Slashdot  --budget 100 
# python gcomb_test.py --dataset Twitter  --budget 100 
# python gcomb_test.py --dataset web-Google  --budget 100 
# python gcomb_test.py --dataset Wiki  --budget 100 
# python gcomb_test.py --dataset YouTube  --budget 100
