...
def quickfilter_random(dataset, cost_model , max_budget, min_budget,delta ,eps,num_rr):
    ...
    save_folder = f'data/{dataset}/knapsack_random'
...
if __name__ == "__main__":
    ...
    quickfilter_random(dataset=dataset, cost_model=cost_model , 
